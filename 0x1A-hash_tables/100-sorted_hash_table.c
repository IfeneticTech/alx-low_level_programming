...
/**
 * add_n_shash - a function that adds a node at the
...
/**
 * add_i_shash - a function that adds a node
...
/**
 * shash_table_set - a function that adds a hash (key, value)
...
/**
 * shash_table_print - a function that prints the keys
...
/**
 * shash_table_print_rev - a function that prints the keys
